      ...
      {isLoading && !result ? (
        ...
        <Motion animation="slide-up" delay={3} className="mt-6 space-y-4">
          <div className="glass-card-interactive p-6 text-center">
            <p className="text-sm text-muted-foreground">Préparation métier (écarts de compétences, calcul strict)</p>
            ...
            {result.experience_years != null && result.experience_years > 0 && (
              <p className="mt-1 text-xs text-muted-foreground">
                {result.experience_years} an{result.experience_years > 1 ? "s" : ""} d&apos;expérience LinkedIn
              </p>
            )}
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Le score exige des preuves solides (CV, GitHub, quiz). Les compétences détectées
              automatiquement sur LinkedIn comptent moins et doivent dépasser un seuil de confiance.
            </p>
          </div>
